package com.staging.tests;

/*
It will test weather Cloud solution tool, application server is up and running or not
*/
...
public class COOLStagingTest {
    ...
    public void coolStagingTest() throws InterruptedException
    {
        ...
        driver.get("https://bldbz173028.cloud.dst.ibm.com/login");
